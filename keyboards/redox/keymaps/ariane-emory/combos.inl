...
DEFINE_COMBO_KEYS(l_mid_ou2,         KC_A,    KC_S);
...
DEFINE_COMBO_KEYS(r_top_ou2,         KC_I,    KC_O);
...
DEFINE_COMBO_KEYS(r_mid_ou2,         KC_K,    KC_L);
...
DEFINE_COMBO_KEYS(r_bot_ou2,         KC_COMM, KC_DOT);
