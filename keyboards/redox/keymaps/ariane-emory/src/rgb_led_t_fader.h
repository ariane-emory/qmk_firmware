...
typedef struct rgb_led_t_fader_t {
  rgb_led_t   initial;
  rgb_led_t   current;
  rgb_led_t   target;
  uint8_t step;
...
#define rgb_led_t_fader_set_target_from_rgb(rgb_led_t_fader_p, rgb_p)                                                                                   \
  rgb_led_t_fader_set_target(rgb_led_t_fader_p, ((rgb_p)->r), ((rgb_p)->g), ((rgb_p)->b))

#define rgb_led_t_fader_init_from_rgb(rgb_led_t_fader_p, rgb_p)                             \
  rgb_led_t_fader_init(rgb_led_t_fader_p, ((rgb_p)->r), ((rgb_p)->g), ((rgb_p)->b))
