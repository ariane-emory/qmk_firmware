...
#define MY_RGB_TOGGLED_ARROWS_LAYER_ON       0x00, 0x34, 0xF0 // blue 
...
#define DOUBLE_QUOTE_TIMEOUT                 400
...
// #define CANARY_COLSWAP
#define CANARY_PUNCTUATION
#define CANARY_MP_SWAP
#define CANARY_BZ_SWAP
