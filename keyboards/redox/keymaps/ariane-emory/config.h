...
#define MY_RGB_LOWER_LAYER_ON                0x00, 0xFF, 0x18 // blue-ish green
#define MY_RGB_UPPER_LAYER_ON                0xFF, 0x00, 0x50 // magenta-ish
#define MY_RGB_ADJUST_LAYER_ON               0xFF, 0xB0, 0x00 // 0xFF, 0x18, 0x00 // orange-ish
#define MY_RGB_TOGGLED_LAYER_ON              0x40, 0xFF, 0x00 // RGB_CHARTREUSE
#define MY_RGB_BOOT                          0x20, 0x00, 0xFF // RGB_GOLD // 0x0,  0xFF, 0x20
