...
#define TELEPORT(_)                                                                                                                                   \
  ...
  ESC() dd() SS_LGUI("l") dd() SS_LGUI("a") dd() SS_LGUI("v") dd() T(X_ENT) SS_DELAY(1750)                                                            \
  T(X_F) dd() RR() RR() RR() RR() RR() dd()                                                                                                           \
  SS_LGUI("`") dd() SCR_L() dd()
...
#define LINE() SS_LCTL("e") SS_LCTL(SS_TAP(X_SPC)) SS_LCTL("a") SS_TAP(X_BSPC)
