...
void leader_end_user(void) {
  ...
  else if (leader_sequence_two_keys(KC_D, KC_R)) { /* implement refactor */ SEND_STRING_WITHOUT_MODS_P(PSTR("Please implement the first uncompleted phase of the plan in @refactoring-plan.md and mark it as complete in the file once you have finished."));}
