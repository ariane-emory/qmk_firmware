...
#define TELEPORT (SS_LGUI("l") SS_LGUI("a") SS_LGUI("x")  SS_LGUI("w") SS_LGUI("`") SS_TAP(X_ESC) SS_LGUI("t") SS_LGUI("l") SS_LGUI("a") SS_LGUI("v")  SS_TAP(X_ENT) SS_DELAY(500) SS_TAP(X_F))
