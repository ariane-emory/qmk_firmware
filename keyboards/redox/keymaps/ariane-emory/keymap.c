...
void leader_end_user(void) {
  ...
  else if (leader_sequence_two_keys(KC_A, KC_E)) { /* analyze and explain */ do_not_edit(); SEND_STRING_WITHOUT_MODS_P(PSTR(", for now I am just need you to analyze and explain this problem: "));} 
  ...
  else if (leader_sequence_two_keys(KC_Q, KC_Q)) { /* ask */ do_not_edit(); SEND_STRING_WITHOUT_MODS_P(PSTR(", for now I am just asking you questions about the current code: "));}
